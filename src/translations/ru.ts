export const ruTranslations = {
  ...
  founded_story: "Основанный в 2018 году, наш бар быстро стал популярным местом для ценителей коктейлей и любителей ночной жизни. То, что начиналось как проект по страсти группы друзей, превратилось в одно из лучших питейных заведений города.",
  mixologists_blend: "Наши опытные бармены сочетают традиционные техники с современными инновациями, создавая коктейли, которые одновременно знакомы и удивительны. Каждый ингредиент тщательно отобран, а каждое украшение аккуратно размещено.",
  craft_mixology: "Крафтовая Миксология",
  expertly_crafted_unique: "Искусно созданные уникальные напитки",
  award_winning: "Отмеченный Наградами",
  recognized_excellence: "Признанное совершенство",
